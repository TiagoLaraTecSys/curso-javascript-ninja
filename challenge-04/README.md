...
carro.adicionarPessoas = function(nPessoas){
    ...
    if (nPessoas > carro.assentos && carro.quantidadePessoas == 0){

        carro.quantidadePessoas = 5;
        return 'Cabe somente 5 pessoas no carro. Terão que ficar '+ (nPessoas-5) + ' pessoas de fora :/';
